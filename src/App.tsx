...
import {
  ...
  parseSliderConfig,
  preserveSliderConfigFromPreviousRaw,
    ...
    >
      ...
      <section className="graph-area">
        ...
        <div className="graph-stage">
          ...
          <GraphControls
            isViewportDirty={isViewportDirty}
            onStartZoomIn={() => startContinuousZoom("in")}
            onStartZoomOut={() => startContinuousZoom("out")}
            onStopZoom={stopContinuousZoom}
            onZoomIn={zoomIn}
            onZoomOut={zoomOut}
